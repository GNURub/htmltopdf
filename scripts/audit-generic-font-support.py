...
CHECKS = {
    "automatic non-WinAnsi selection": (ROOT / "crates/htmlpdf-core/src/pdf.rs", "font_requires_embedding"),
    "opt-in all-font override": (ROOT / "crates/htmlpdf-core/src/pdf.rs", "HTMLPDF_EMBED_FONTS"),
